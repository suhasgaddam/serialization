...
class ArrayPicklerTest {
  ...
  def testRoundtrip: Unit = {
    ...
    roundTripArray(Array[Long](1L, 2L, 3L))
    roundTripArray(Array[Short](1: Short, 2: Short, 3: Short))
    roundTripArray(Array[Byte](192.toByte, 168.toByte, 255.toByte, 255.toByte))
    roundTripArray(Array(1.0, 2.0, 3.0))
